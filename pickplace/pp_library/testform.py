...
class TransformClass():
    def __init__(self):
        ...
        self.publish_node = rclpy.create_node('publisher')
        self.tfb = TransformBroadcaster(self.publish_node)
    ...
    def update_vbase(self, vbasequat, vbase_name):
        ...
        self.tfb.sendTransform(base_to_vbase)
        #rclpy.spin_once(self.publish_node)
