...
#include <stddef.h>
#include "tmr_msgs/srv/detail/set_positions__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember SetPositions_Request__rosidl_typesupport_introspection_c__SetPositions_Request_message_member_array[6] = {
  {
    ...
    offsetof(tmr_msgs__srv__SetPositions_Request, motion_type),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetPositions_Request, positions),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetPositions_Request, velocity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetPositions_Request, acc_time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetPositions_Request, blend_percentage),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetPositions_Request, fine_goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetPositions_Request__rosidl_typesupport_introspection_c__SetPositions_Request_message_members = {
  ...
  6,  // number of fields
  sizeof(tmr_msgs__srv__SetPositions_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetPositions_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember SetPositions_Response__rosidl_typesupport_introspection_c__SetPositions_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetPositions_Response, ok),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetPositions_Response__rosidl_typesupport_introspection_c__SetPositions_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tmr_msgs__srv__SetPositions_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_tmr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetPositions_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers tmr_msgs__srv__detail__set_positions__rosidl_typesupport_introspection_c__SetPositions_service_members = {
  "tmr_msgs__srv",  // service namespace
  "SetPositions",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // tmr_msgs__srv__detail__set_positions__rosidl_typesupport_introspection_c__SetPositions_Request_message_type_support_handle,
  NULL  // response message
  // tmr_msgs__srv__detail__set_positions__rosidl_typesupport_introspection_c__SetPositions_Response_message_type_support_handle
};

static rosidl_service_type_support_t tmr_msgs__srv__detail__set_positions__rosidl_typesupport_introspection_c__SetPositions_service_type_support_handle = {
  0,
  &tmr_msgs__srv__detail__set_positions__rosidl_typesupport_introspection_c__SetPositions_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetPositions)() {
  if (!tmr_msgs__srv__detail__set_positions__rosidl_typesupport_introspection_c__SetPositions_service_type_support_handle.typesupport_identifier) {
    tmr_msgs__srv__detail__set_positions__rosidl_typesupport_introspection_c__SetPositions_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)tmr_msgs__srv__detail__set_positions__rosidl_typesupport_introspection_c__SetPositions_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetPositions_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetPositions_Response)()->data;
  }

  return &tmr_msgs__srv__detail__set_positions__rosidl_typesupport_introspection_c__SetPositions_service_type_support_handle;
}
