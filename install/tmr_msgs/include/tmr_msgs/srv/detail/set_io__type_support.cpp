...
{
  new (message_memory) tmr_msgs::srv::SetIO_Request(_init);
}

void SetIO_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tmr_msgs::srv::SetIO_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetIO_Request_message_member_array[4] = {
  {
    ...
    offsetof(tmr_msgs::srv::SetIO_Request, module),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs::srv::SetIO_Request, type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs::srv::SetIO_Request, pin),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs::srv::SetIO_Request, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetIO_Request_message_members = {
  ...
  4,  // number of fields
  sizeof(tmr_msgs::srv::SetIO_Request),
...
get_message_type_support_handle<tmr_msgs::srv::SetIO_Request>()
{
  return &::tmr_msgs::srv::rosidl_typesupport_introspection_cpp::SetIO_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, SetIO_Request)() {
  return &::tmr_msgs::srv::rosidl_typesupport_introspection_cpp::SetIO_Request_message_type_support_handle;
}
...
void SetIO_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) tmr_msgs::srv::SetIO_Response(_init);
}

void SetIO_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tmr_msgs::srv::SetIO_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetIO_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs::srv::SetIO_Response, ok),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetIO_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tmr_msgs::srv::SetIO_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<tmr_msgs::srv::SetIO_Response>()
{
  return &::tmr_msgs::srv::rosidl_typesupport_introspection_cpp::SetIO_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, SetIO_Response)() {
  return &::tmr_msgs::srv::rosidl_typesupport_introspection_cpp::SetIO_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers SetIO_service_members = {
  ...
  // see get_service_type_support_handle<tmr_msgs::srv::SetIO>()
...
get_service_type_support_handle<tmr_msgs::srv::SetIO>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::tmr_msgs::srv::rosidl_typesupport_introspection_cpp::SetIO_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, SetIO)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<tmr_msgs::srv::SetIO>();
}
