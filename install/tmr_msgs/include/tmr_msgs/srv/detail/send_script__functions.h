...
#ifndef TMR_MSGS__SRV__DETAIL__SEND_SCRIPT__FUNCTIONS_H_
#define TMR_MSGS__SRV__DETAIL__SEND_SCRIPT__FUNCTIONS_H_
 ...
 * calls
 * tmr_msgs__srv__SendScript_Request__init().
...
/**
 * It calls
 * tmr_msgs__srv__SendScript_Request__fini()
 ...
 * tmr_msgs__srv__SendScript_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tmr_msgs__srv__SendScript_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tmr_msgs__srv__SendScript_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tmr_msgs
...
/**
 * It calls
 * tmr_msgs__srv__SendScript_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tmr_msgs
...
/**
 * It allocates the memory for the array and calls
 * tmr_msgs__srv__SendScript_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tmr_msgs
...
/**
 * It calls
 * tmr_msgs__srv__SendScript_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TMR_MSGS__SRV__DETAIL__SEND_SCRIPT__FUNCTIONS_H_
