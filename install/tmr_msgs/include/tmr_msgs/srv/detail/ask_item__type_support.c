...
#include <stddef.h>
#include "tmr_msgs/srv/detail/ask_item__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember AskItem_Request__rosidl_typesupport_introspection_c__AskItem_Request_message_member_array[3] = {
  {
    ...
    offsetof(tmr_msgs__srv__AskItem_Request, id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__AskItem_Request, item),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__AskItem_Request, wait_time),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers AskItem_Request__rosidl_typesupport_introspection_c__AskItem_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(tmr_msgs__srv__AskItem_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, AskItem_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember AskItem_Response__rosidl_typesupport_introspection_c__AskItem_Response_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__AskItem_Response, ok),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__AskItem_Response, id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__AskItem_Response, value),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers AskItem_Response__rosidl_typesupport_introspection_c__AskItem_Response_message_members = {
  ...
  3,  // number of fields
  sizeof(tmr_msgs__srv__AskItem_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_tmr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, AskItem_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers tmr_msgs__srv__detail__ask_item__rosidl_typesupport_introspection_c__AskItem_service_members = {
  "tmr_msgs__srv",  // service namespace
  "AskItem",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // tmr_msgs__srv__detail__ask_item__rosidl_typesupport_introspection_c__AskItem_Request_message_type_support_handle,
  NULL  // response message
  // tmr_msgs__srv__detail__ask_item__rosidl_typesupport_introspection_c__AskItem_Response_message_type_support_handle
};

static rosidl_service_type_support_t tmr_msgs__srv__detail__ask_item__rosidl_typesupport_introspection_c__AskItem_service_type_support_handle = {
  0,
  &tmr_msgs__srv__detail__ask_item__rosidl_typesupport_introspection_c__AskItem_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, AskItem)() {
  if (!tmr_msgs__srv__detail__ask_item__rosidl_typesupport_introspection_c__AskItem_service_type_support_handle.typesupport_identifier) {
    tmr_msgs__srv__detail__ask_item__rosidl_typesupport_introspection_c__AskItem_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)tmr_msgs__srv__detail__ask_item__rosidl_typesupport_introspection_c__AskItem_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, AskItem_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, AskItem_Response)()->data;
  }

  return &tmr_msgs__srv__detail__ask_item__rosidl_typesupport_introspection_c__AskItem_service_type_support_handle;
}
