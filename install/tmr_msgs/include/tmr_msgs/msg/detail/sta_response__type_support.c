...
#include <stddef.h>
#include "tmr_msgs/msg/detail/sta_response__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember StaResponse__rosidl_typesupport_introspection_c__StaResponse_message_member_array[3] = {
  {
    ...
    offsetof(tmr_msgs__msg__StaResponse, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__msg__StaResponse, subcmd),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__msg__StaResponse, subdata),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StaResponse__rosidl_typesupport_introspection_c__StaResponse_message_members = {
  ...
  3,  // number of fields
  sizeof(tmr_msgs__msg__StaResponse),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, msg, StaResponse)() {
