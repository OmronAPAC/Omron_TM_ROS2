...
{
  new (message_memory) tmr_msgs::msg::SctResponse(_init);
}

void SctResponse_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tmr_msgs::msg::SctResponse *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SctResponse_message_member_array[3] = {
  {
    ...
    offsetof(tmr_msgs::msg::SctResponse, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs::msg::SctResponse, id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs::msg::SctResponse, script),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SctResponse_message_members = {
  ...
  3,  // number of fields
  sizeof(tmr_msgs::msg::SctResponse),
...
{
  return &::tmr_msgs::msg::rosidl_typesupport_introspection_cpp::SctResponse_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, msg, SctResponse)() {
  return &::tmr_msgs::msg::rosidl_typesupport_introspection_cpp::SctResponse_message_type_support_handle;
}
