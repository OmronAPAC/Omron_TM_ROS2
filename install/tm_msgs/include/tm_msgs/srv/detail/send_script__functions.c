...
{
  tm_msgs__srv__SendScript_Request * msg = (tm_msgs__srv__SendScript_Request *)malloc(sizeof(tm_msgs__srv__SendScript_Request));
  if (!msg) {
    return NULL;
  }
...
tm_msgs__srv__SendScript_Request__Sequence__init(tm_msgs__srv__SendScript_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tm_msgs__srv__SendScript_Request *)calloc(size, sizeof(tm_msgs__srv__SendScript_Request));
    if (!data) {
      return false;
    }
...
{
  tm_msgs__srv__SendScript_Request__Sequence * array = (tm_msgs__srv__SendScript_Request__Sequence *)malloc(sizeof(tm_msgs__srv__SendScript_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  tm_msgs__srv__SendScript_Response * msg = (tm_msgs__srv__SendScript_Response *)malloc(sizeof(tm_msgs__srv__SendScript_Response));
  if (!msg) {
    return NULL;
  }
...
tm_msgs__srv__SendScript_Response__Sequence__init(tm_msgs__srv__SendScript_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (tm_msgs__srv__SendScript_Response *)calloc(size, sizeof(tm_msgs__srv__SendScript_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  tm_msgs__srv__SendScript_Response__Sequence * array = (tm_msgs__srv__SendScript_Response__Sequence *)malloc(sizeof(tm_msgs__srv__SendScript_Response__Sequence));
  if (!array) {
    return NULL;
  }
