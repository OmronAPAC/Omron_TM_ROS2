...
class TransformClass():
    def __init__(self):
        ...
        """
    def add_pick_and_place(self, pickquat, placequat):
        ...
        base_to_pick.transform.translation.x = pickquat[0]
        base_to_pick.transform.translation.y = pickquat[1]
        base_to_pick.transform.translation.z = pickquat[2]
        ...
        base_to_place.transform.translation.x = placequat[0]
        base_to_place.transform.translation.y = placequat[1]
        base_to_place.transform.translation.z = placequat[2]
