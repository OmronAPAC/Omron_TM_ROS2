...
class Metaclass_SetEvent(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tmr_msgs.srv import _set_event
...
class SetEvent(metaclass=Metaclass_SetEvent):
    from tmr_msgs.srv._set_event import SetEvent_Request as Request
    from tmr_msgs.srv._set_event import SetEvent_Response as Response
