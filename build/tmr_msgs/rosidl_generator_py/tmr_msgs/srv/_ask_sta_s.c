...
bool tmr_msgs__srv__ask_sta__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tmr_msgs.srv._ask_sta.AskSta_Request", full_classname_dest, 36) == 0);
  }
  tmr_msgs__srv__AskSta_Request * ros_message = _ros_message;
  {  // subcmd
...
PyObject * tmr_msgs__srv__ask_sta__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tmr_msgs.srv._ask_sta");
...
ROSIDL_GENERATOR_C_EXPORT
bool tmr_msgs__srv__ask_sta__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tmr_msgs.srv._ask_sta.AskSta_Response", full_classname_dest, 37) == 0);
  }
  tmr_msgs__srv__AskSta_Response * ros_message = _ros_message;
  {  // ok
