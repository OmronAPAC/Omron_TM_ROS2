...
bool tmr_msgs__srv__connect_tm__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tmr_msgs.srv._connect_tm.ConnectTM_Request", full_classname_dest, 42) == 0);
  }
  tmr_msgs__srv__ConnectTM_Request * ros_message = _ros_message;
  {  // server
...
PyObject * tmr_msgs__srv__connect_tm__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tmr_msgs.srv._connect_tm");
...
ROSIDL_GENERATOR_C_EXPORT
bool tmr_msgs__srv__connect_tm__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tmr_msgs.srv._connect_tm.ConnectTM_Response", full_classname_dest, 43) == 0);
  }
  tmr_msgs__srv__ConnectTM_Response * ros_message = _ros_message;
  {  // ok
