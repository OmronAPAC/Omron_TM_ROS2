...
class Metaclass_ConnectTM(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tmr_msgs.srv import _connect_tm
...
class ConnectTM(metaclass=Metaclass_ConnectTM):
    from tmr_msgs.srv._connect_tm import ConnectTM_Request as Request
    from tmr_msgs.srv._connect_tm import ConnectTM_Response as Response
