...
class Metaclass_AskItem(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tmr_msgs.srv import _ask_item
...
class AskItem(metaclass=Metaclass_AskItem):
    from tmr_msgs.srv._ask_item import AskItem_Request as Request
    from tmr_msgs.srv._ask_item import AskItem_Response as Response
