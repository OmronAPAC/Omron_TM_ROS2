...
class Metaclass_SetPositions_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('tmr_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SetPositions(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from tmr_msgs.srv import _set_positions
...
class SetPositions(metaclass=Metaclass_SetPositions):
    from tmr_msgs.srv._set_positions import SetPositions_Request as Request
    from tmr_msgs.srv._set_positions import SetPositions_Response as Response
