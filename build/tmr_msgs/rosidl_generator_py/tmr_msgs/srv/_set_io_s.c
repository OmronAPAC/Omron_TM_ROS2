...
bool tmr_msgs__srv__set_io__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tmr_msgs.srv._set_io.SetIO_Request", full_classname_dest, 34) == 0);
  }
  tmr_msgs__srv__SetIO_Request * ros_message = _ros_message;
  {  // module
...
PyObject * tmr_msgs__srv__set_io__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tmr_msgs.srv._set_io");
...
ROSIDL_GENERATOR_C_EXPORT
bool tmr_msgs__srv__set_io__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tmr_msgs.srv._set_io.SetIO_Response", full_classname_dest, 35) == 0);
  }
  tmr_msgs__srv__SetIO_Response * ros_message = _ros_message;
  {  // ok
