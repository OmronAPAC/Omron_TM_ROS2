...
bool tmr_msgs__msg__svr_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tmr_msgs.msg._svr_response.SvrResponse", full_classname_dest, 38) == 0);
  }
  tmr_msgs__msg__SvrResponse * ros_message = _ros_message;
  {  // header
...
PyObject * tmr_msgs__msg__svr_response__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tmr_msgs.msg._svr_response");
