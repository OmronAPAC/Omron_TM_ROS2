...
class FeedbackState(metaclass=Metaclass_FeedbackState):
    ...
    def __init__(self, **kwargs):
        ...
        self.flange_pose = array.array('d', kwargs.get('flange_pose', []))
    ...
    def flange_pose(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'flange_pose' array.array() must have the type code of 'd'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 True), \
                "The 'flange_pose' field must be a set or sequence and each value of type 'float'"
        self._flange_pose = array.array('d', value)
