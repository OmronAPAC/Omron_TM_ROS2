...
#include <stddef.h>
#include "tmr_msgs/srv/detail/set_io__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tmr_msgs__srv__SetIO_Request__init(message_memory);
}

void SetIO_Request__rosidl_typesupport_introspection_c__SetIO_Request_fini_function(void * message_memory)
{
  tmr_msgs__srv__SetIO_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetIO_Request__rosidl_typesupport_introspection_c__SetIO_Request_message_member_array[4] = {
  {
    "module",  // name
    ...
    offsetof(tmr_msgs__srv__SetIO_Request, module),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetIO_Request, type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetIO_Request, pin),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetIO_Request, state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetIO_Request__rosidl_typesupport_introspection_c__SetIO_Request_message_members = {
  ...
  4,  // number of fields
  sizeof(tmr_msgs__srv__SetIO_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetIO_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember SetIO_Response__rosidl_typesupport_introspection_c__SetIO_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tmr_msgs__srv__SetIO_Response, ok),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers SetIO_Response__rosidl_typesupport_introspection_c__SetIO_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tmr_msgs__srv__SetIO_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_tmr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetIO_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers tmr_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_members = {
  "tmr_msgs__srv",  // service namespace
  "SetIO",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // tmr_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_Request_message_type_support_handle,
  NULL  // response message
  // tmr_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_Response_message_type_support_handle
};

static rosidl_service_type_support_t tmr_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle = {
  0,
  &tmr_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetIO)() {
  if (!tmr_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle.typesupport_identifier) {
    tmr_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)tmr_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetIO_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetIO_Response)()->data;
  }

  return &tmr_msgs__srv__detail__set_io__rosidl_typesupport_introspection_c__SetIO_service_type_support_handle;
}
