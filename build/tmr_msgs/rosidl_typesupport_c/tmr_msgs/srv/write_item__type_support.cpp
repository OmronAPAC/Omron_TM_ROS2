...
static const _WriteItem_Request_type_support_symbol_names_t _WriteItem_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, WriteItem_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, WriteItem_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tmr_msgs, srv, WriteItem_Request)() {
  return &::tmr_msgs::srv::rosidl_typesupport_c::WriteItem_Request_message_type_support_handle;
}
...
static const _WriteItem_Response_type_support_symbol_names_t _WriteItem_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, WriteItem_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, WriteItem_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_tmr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tmr_msgs, srv, WriteItem_Response)() {
  return &::tmr_msgs::srv::rosidl_typesupport_c::WriteItem_Response_message_type_support_handle;
}
...
static const _WriteItem_type_support_symbol_names_t _WriteItem_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, WriteItem)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, WriteItem)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tmr_msgs, srv, WriteItem)() {
  return &::tmr_msgs::srv::rosidl_typesupport_c::WriteItem_service_type_support_handle;
}
