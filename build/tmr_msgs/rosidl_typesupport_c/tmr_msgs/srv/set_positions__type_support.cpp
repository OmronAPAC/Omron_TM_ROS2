...
static const _SetPositions_Request_type_support_symbol_names_t _SetPositions_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, SetPositions_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetPositions_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tmr_msgs, srv, SetPositions_Request)() {
  return &::tmr_msgs::srv::rosidl_typesupport_c::SetPositions_Request_message_type_support_handle;
}
...
static const _SetPositions_Response_type_support_symbol_names_t _SetPositions_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, SetPositions_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetPositions_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_tmr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tmr_msgs, srv, SetPositions_Response)() {
  return &::tmr_msgs::srv::rosidl_typesupport_c::SetPositions_Response_message_type_support_handle;
}
...
static const _SetPositions_type_support_symbol_names_t _SetPositions_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, SetPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, SetPositions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tmr_msgs, srv, SetPositions)() {
  return &::tmr_msgs::srv::rosidl_typesupport_c::SetPositions_service_type_support_handle;
}
