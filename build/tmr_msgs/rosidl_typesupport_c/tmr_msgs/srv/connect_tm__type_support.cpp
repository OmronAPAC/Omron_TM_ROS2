...
static const _ConnectTM_Request_type_support_symbol_names_t _ConnectTM_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, ConnectTM_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, ConnectTM_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tmr_msgs, srv, ConnectTM_Request)() {
  return &::tmr_msgs::srv::rosidl_typesupport_c::ConnectTM_Request_message_type_support_handle;
}
...
static const _ConnectTM_Response_type_support_symbol_names_t _ConnectTM_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, ConnectTM_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, ConnectTM_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_tmr_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tmr_msgs, srv, ConnectTM_Response)() {
  return &::tmr_msgs::srv::rosidl_typesupport_c::ConnectTM_Response_message_type_support_handle;
}
...
static const _ConnectTM_type_support_symbol_names_t _ConnectTM_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, ConnectTM)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tmr_msgs, srv, ConnectTM)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tmr_msgs, srv, ConnectTM)() {
  return &::tmr_msgs::srv::rosidl_typesupport_c::ConnectTM_service_type_support_handle;
}
