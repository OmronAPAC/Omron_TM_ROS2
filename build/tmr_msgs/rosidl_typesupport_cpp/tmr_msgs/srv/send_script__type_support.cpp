...
static const _SendScript_Request_type_support_symbol_names_t _SendScript_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, SendScript_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, SendScript_Request)),
  }
};
...
{
  return &::tmr_msgs::srv::rosidl_typesupport_cpp::SendScript_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tmr_msgs, srv, SendScript_Request)() {
  return get_message_type_support_handle<tmr_msgs::srv::SendScript_Request>();
}
...
static const _SendScript_Response_type_support_symbol_names_t _SendScript_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, SendScript_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, SendScript_Response)),
  }
};
...
{
  return &::tmr_msgs::srv::rosidl_typesupport_cpp::SendScript_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tmr_msgs, srv, SendScript_Response)() {
  return get_message_type_support_handle<tmr_msgs::srv::SendScript_Response>();
}
...
static const _SendScript_type_support_symbol_names_t _SendScript_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, SendScript)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, SendScript)),
  }
};
...
{
  return &::tmr_msgs::srv::rosidl_typesupport_cpp::SendScript_service_type_support_handle;
}
