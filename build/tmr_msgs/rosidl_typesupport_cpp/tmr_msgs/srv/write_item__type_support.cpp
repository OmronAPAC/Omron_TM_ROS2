...
static const _WriteItem_Request_type_support_symbol_names_t _WriteItem_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, WriteItem_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, WriteItem_Request)),
  }
};
...
{
  return &::tmr_msgs::srv::rosidl_typesupport_cpp::WriteItem_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tmr_msgs, srv, WriteItem_Request)() {
  return get_message_type_support_handle<tmr_msgs::srv::WriteItem_Request>();
}
...
static const _WriteItem_Response_type_support_symbol_names_t _WriteItem_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, WriteItem_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, WriteItem_Response)),
  }
};
...
{
  return &::tmr_msgs::srv::rosidl_typesupport_cpp::WriteItem_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tmr_msgs, srv, WriteItem_Response)() {
  return get_message_type_support_handle<tmr_msgs::srv::WriteItem_Response>();
}
...
static const _WriteItem_type_support_symbol_names_t _WriteItem_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, WriteItem)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, WriteItem)),
  }
};
...
{
  return &::tmr_msgs::srv::rosidl_typesupport_cpp::WriteItem_service_type_support_handle;
}
