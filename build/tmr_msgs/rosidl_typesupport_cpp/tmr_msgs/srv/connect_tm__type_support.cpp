...
static const _ConnectTM_Request_type_support_symbol_names_t _ConnectTM_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, ConnectTM_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, ConnectTM_Request)),
  }
};
...
{
  return &::tmr_msgs::srv::rosidl_typesupport_cpp::ConnectTM_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tmr_msgs, srv, ConnectTM_Request)() {
  return get_message_type_support_handle<tmr_msgs::srv::ConnectTM_Request>();
}
...
static const _ConnectTM_Response_type_support_symbol_names_t _ConnectTM_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, ConnectTM_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, ConnectTM_Response)),
  }
};
...
{
  return &::tmr_msgs::srv::rosidl_typesupport_cpp::ConnectTM_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tmr_msgs, srv, ConnectTM_Response)() {
  return get_message_type_support_handle<tmr_msgs::srv::ConnectTM_Response>();
}
...
static const _ConnectTM_type_support_symbol_names_t _ConnectTM_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, ConnectTM)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tmr_msgs, srv, ConnectTM)),
  }
};
...
{
  return &::tmr_msgs::srv::rosidl_typesupport_cpp::ConnectTM_service_type_support_handle;
}
