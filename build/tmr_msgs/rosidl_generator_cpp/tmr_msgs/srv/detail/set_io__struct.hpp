...
#ifndef TMR_MSGS__SRV__DETAIL__SET_IO__STRUCT_HPP_
#define TMR_MSGS__SRV__DETAIL__SET_IO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__tmr_msgs__srv__SetIO_Request __attribute__((deprecated))
#else
# define DEPRECATED__tmr_msgs__srv__SetIO_Request __declspec(deprecated)
#endif
...
struct SetIO_Request_
{
  ...
  // pointer types
  using RawPtr =
    tmr_msgs::srv::SetIO_Request_<ContainerAllocator> *;
  using ConstRawPtr =
    const tmr_msgs::srv::SetIO_Request_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<tmr_msgs::srv::SetIO_Request_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<tmr_msgs::srv::SetIO_Request_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      tmr_msgs::srv::SetIO_Request_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<tmr_msgs::srv::SetIO_Request_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<tmr_msgs::srv::SetIO_Request_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<tmr_msgs::srv::SetIO_Request_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<tmr_msgs::srv::SetIO_Request_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__tmr_msgs__srv__SetIO_Request
    std::shared_ptr<tmr_msgs::srv::SetIO_Request_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__tmr_msgs__srv__SetIO_Request
    std::shared_ptr<tmr_msgs::srv::SetIO_Request_<ContainerAllocator> const>
...
using SetIO_Request =
  tmr_msgs::srv::SetIO_Request_<std::allocator<void>>;
...
#ifndef _WIN32
# define DEPRECATED__tmr_msgs__srv__SetIO_Response __attribute__((deprecated))
#else
# define DEPRECATED__tmr_msgs__srv__SetIO_Response __declspec(deprecated)
#endif
...
struct SetIO_Response_
{
  ...
  // pointer types
  using RawPtr =
    tmr_msgs::srv::SetIO_Response_<ContainerAllocator> *;
  using ConstRawPtr =
    const tmr_msgs::srv::SetIO_Response_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<tmr_msgs::srv::SetIO_Response_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<tmr_msgs::srv::SetIO_Response_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      tmr_msgs::srv::SetIO_Response_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<tmr_msgs::srv::SetIO_Response_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      tmr_msgs::srv::SetIO_Response_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<tmr_msgs::srv::SetIO_Response_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<tmr_msgs::srv::SetIO_Response_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<tmr_msgs::srv::SetIO_Response_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__tmr_msgs__srv__SetIO_Response
    std::shared_ptr<tmr_msgs::srv::SetIO_Response_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__tmr_msgs__srv__SetIO_Response
    std::shared_ptr<tmr_msgs::srv::SetIO_Response_<ContainerAllocator> const>
...
using SetIO_Response =
  tmr_msgs::srv::SetIO_Response_<std::allocator<void>>;
...
struct SetIO
{
  using Request = tmr_msgs::srv::SetIO_Request;
  using Response = tmr_msgs::srv::SetIO_Response;
};
...
#endif  // TMR_MSGS__SRV__DETAIL__SET_IO__STRUCT_HPP_
