...
#include "tmr_msgs/msg/detail/feedback_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tmr_msgs::msg::FeedbackState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tmr_msgs::msg::FeedbackState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: flange_pose
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.flange_pose[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: tool_pose
...
{
  auto typed_message =
    static_cast<const tmr_msgs::msg::FeedbackState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tmr_msgs::msg::FeedbackState *>(
    untyped_ros_message);
...
{
  return &tmr_msgs::msg::typesupport_fastrtps_cpp::_FeedbackState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, msg, FeedbackState)() {
  return &tmr_msgs::msg::typesupport_fastrtps_cpp::_FeedbackState__handle;
}
