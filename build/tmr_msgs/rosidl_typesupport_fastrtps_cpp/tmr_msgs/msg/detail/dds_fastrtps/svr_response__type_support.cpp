...
#include "tmr_msgs/msg/detail/svr_response__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tmr_msgs::msg::SvrResponse *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tmr_msgs::msg::SvrResponse *>(
    untyped_ros_message);
...
{
  return &tmr_msgs::msg::typesupport_fastrtps_cpp::_SvrResponse__handle;
}
