...
#include "tmr_msgs/srv/detail/set_positions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tmr_msgs::srv::SetPositions_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tmr_msgs::srv::SetPositions_Request & ros_message)
{
  // Member: motion_type
  cdr >> ros_message.motion_type;
...
{
  auto typed_message =
    static_cast<const tmr_msgs::srv::SetPositions_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tmr_msgs::srv::SetPositions_Request *>(
    untyped_ros_message);
...
{
  return &tmr_msgs::srv::typesupport_fastrtps_cpp::_SetPositions_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, SetPositions_Request)() {
  return &tmr_msgs::srv::typesupport_fastrtps_cpp::_SetPositions_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tmr_msgs
cdr_serialize(
  const tmr_msgs::srv::SetPositions_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: ok
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tmr_msgs::srv::SetPositions_Response & ros_message)
{
  // Member: ok
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const tmr_msgs::srv::SetPositions_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tmr_msgs::srv::SetPositions_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tmr_msgs::srv::typesupport_fastrtps_cpp::_SetPositions_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, SetPositions_Response)() {
  return &tmr_msgs::srv::typesupport_fastrtps_cpp::_SetPositions_Response__handle;
}
...
{
  return &tmr_msgs::srv::typesupport_fastrtps_cpp::_SetPositions__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tmr_msgs, srv, SetPositions)() {
  return &tmr_msgs::srv::typesupport_fastrtps_cpp::_SetPositions__handle;
}
