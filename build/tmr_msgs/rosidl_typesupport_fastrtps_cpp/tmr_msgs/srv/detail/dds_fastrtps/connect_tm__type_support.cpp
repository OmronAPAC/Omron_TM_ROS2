...
#include "tmr_msgs/srv/detail/connect_tm__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tmr_msgs::srv::ConnectTM_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tmr_msgs::srv::ConnectTM_Request *>(
    untyped_ros_message);
...
{
  return &tmr_msgs::srv::typesupport_fastrtps_cpp::_ConnectTM_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const tmr_msgs::srv::ConnectTM_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tmr_msgs::srv::ConnectTM_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tmr_msgs::srv::typesupport_fastrtps_cpp::_ConnectTM_Response__handle;
}
...
{
  return &tmr_msgs::srv::typesupport_fastrtps_cpp::_ConnectTM__handle;
}
