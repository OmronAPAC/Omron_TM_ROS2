...
#include "tmr_msgs/srv/detail/ask_item__rosidl_typesupport_fastrtps_c.h"
...
using _AskItem_Request__ros_msg_type = tmr_msgs__srv__AskItem_Request;
...
size_t get_serialized_size_tmr_msgs__srv__AskItem_Request(
  const void * untyped_ros_message,
...
static uint32_t _AskItem_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tmr_msgs__srv__AskItem_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tmr_msgs
size_t max_serialized_size_tmr_msgs__srv__AskItem_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tmr_msgs__srv__AskItem_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, AskItem_Request)() {
...
using _AskItem_Response__ros_msg_type = tmr_msgs__srv__AskItem_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tmr_msgs
size_t get_serialized_size_tmr_msgs__srv__AskItem_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AskItem_Response__ros_msg_type * ros_message = static_cast<const _AskItem_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tmr_msgs__srv__AskItem_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tmr_msgs
size_t max_serialized_size_tmr_msgs__srv__AskItem_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tmr_msgs__srv__AskItem_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, AskItem_Response)() {
...
// already included above
// #include "tmr_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "tmr_msgs/srv/ask_item.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, AskItem)() {
