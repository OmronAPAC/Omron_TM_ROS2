...
#include "tmr_msgs/srv/detail/ask_sta__rosidl_typesupport_fastrtps_c.h"
...
using _AskSta_Request__ros_msg_type = tmr_msgs__srv__AskSta_Request;
...
size_t get_serialized_size_tmr_msgs__srv__AskSta_Request(
  const void * untyped_ros_message,
...
static uint32_t _AskSta_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tmr_msgs__srv__AskSta_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tmr_msgs
size_t max_serialized_size_tmr_msgs__srv__AskSta_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tmr_msgs__srv__AskSta_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, AskSta_Request)() {
...
using _AskSta_Response__ros_msg_type = tmr_msgs__srv__AskSta_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tmr_msgs
size_t get_serialized_size_tmr_msgs__srv__AskSta_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AskSta_Response__ros_msg_type * ros_message = static_cast<const _AskSta_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tmr_msgs__srv__AskSta_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tmr_msgs
size_t max_serialized_size_tmr_msgs__srv__AskSta_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tmr_msgs__srv__AskSta_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, AskSta_Response)() {
...
// already included above
// #include "tmr_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "tmr_msgs/srv/ask_sta.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, srv, AskSta)() {
