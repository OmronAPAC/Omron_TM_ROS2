...
#include "tmr_msgs/msg/detail/sta_response__rosidl_typesupport_fastrtps_c.h"
...
using _StaResponse__ros_msg_type = tmr_msgs__msg__StaResponse;
...
size_t get_serialized_size_tmr_msgs__msg__StaResponse(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StaResponse__ros_msg_type * ros_message = static_cast<const _StaResponse__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _StaResponse__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tmr_msgs__msg__StaResponse(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tmr_msgs
size_t max_serialized_size_tmr_msgs__msg__StaResponse(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _StaResponse__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_tmr_msgs__msg__StaResponse(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, msg, StaResponse)() {
