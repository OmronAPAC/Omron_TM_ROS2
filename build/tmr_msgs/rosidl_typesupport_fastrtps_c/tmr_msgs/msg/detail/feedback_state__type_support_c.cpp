...
#include "tmr_msgs/msg/detail/feedback_state__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // cb_analog_input, cb_analog_output, cb_digital_input, cb_digital_output, ee_analog_input, ee_analog_output, ee_digital_input, ee_digital_output, flange_pose, joint_pos, joint_tor, joint_vel, tcp_force, tcp_speed, tool_pose
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // cb_analog_input, cb_analog_output, cb_digital_input, cb_digital_output, ee_analog_input, ee_analog_output, ee_digital_input, ee_digital_output, flange_pose, joint_pos, joint_tor, joint_vel, tcp_force, tcp_speed, tool_pose
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_tmr_msgs
...
using _FeedbackState__ros_msg_type = tmr_msgs__msg__FeedbackState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = ros_message->flange_pose.size;
    auto array_ptr = ros_message->flange_pose.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serializeArray(array_ptr, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: flange_pose
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->flange_pose.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->flange_pose);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->flange_pose, size)) {
      return "failed to create array for field 'flange_pose'";
    }
    auto array_ptr = ros_message->flange_pose.data;
    cdr.deserializeArray(array_ptr, size);
  }
...
size_t get_serialized_size_tmr_msgs__msg__FeedbackState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _FeedbackState__ros_msg_type * ros_message = static_cast<const _FeedbackState__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name flange_pose
  {
    size_t array_size = ros_message->flange_pose.size;
    auto array_ptr = ros_message->flange_pose.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
...
static uint32_t _FeedbackState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tmr_msgs__msg__FeedbackState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tmr_msgs
size_t max_serialized_size_tmr_msgs__msg__FeedbackState(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_tmr_msgs__msg__FeedbackState(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tmr_msgs, msg, FeedbackState)() {
